...
namespace UnityStandardAssets.Cameras
{
    ...
    public class MixedAutoCam : PivotBasedCameraRig
    {
        ...
        [SerializeField] private float m_WalkBackwardsAngle = 20; // Angle to not move camera when facing the camera
        [SerializeField] private float m_ResetTurnSpeed = 8; // How fast the rig will turn when resetting
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            if(!isResettingCamera && Quaternion.Angle(transform.rotation, rollRotation) > 180 - m_WalkBackwardsAngle) {
